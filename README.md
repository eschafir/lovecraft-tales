...
| **🖼️ Gothic Cover Art** | ![Memory Cover Art](results/memory_cover.png)<br><sub>**Model:** Z-Image-Turbo (int8) • **Resolution:** 768×768 px</sub> |
| **🎙️ Cloned Audiobook** | 🎧 **Master WAV:** [`results/memory.wav`](results/memory.wav)<br>• **Narrator:** Vincent Price (zero-shot clone via CosyVoice3)<br>• **Duration:** `2m 54s` (24 kHz stereo WAV)<br>• **Structure:** 11 sentence chunks with 350ms sentence pauses & 800ms paragraph pauses |
